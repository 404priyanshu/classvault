<!-- Archived 2026-09-24. This was AGENTS.md before it was cut to current facts.
     Dated history, acceptance-test records, and per-migration notes live here; the
     live AGENTS.md at the repository root supersedes anything below that conflicts. -->
