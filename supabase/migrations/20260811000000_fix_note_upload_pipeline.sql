...
$$;
revoke all on function public.can_upload_note_object(text)
...
revoke all on function public.discard_note_upload_draft(uuid)
  from public, anon, authenticated;
grant execute on function public.can_upload_note_object(text)
  to authenticated;
...
grant execute on function public.discard_note_upload_draft(uuid)
  to authenticated;
