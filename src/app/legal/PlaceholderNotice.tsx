...
export function PlaceholderNotice() {
  ...
  return (
    <div className="mb-10 flex gap-3 rounded-xl border border-[#8a5a00] bg-club-yellow/15 p-5">
      <AlertTriangle className="mt-0.5 h-5 w-5 shrink-0 text-[#8a5a00]" />
      <div className="text-sm font-medium leading-relaxed text-club-ink/80">
        <p className="font-bold text-club-ink">This page is not final.</p>
        <p className="mt-1">
          Operator, grievance-officer, and jurisdiction details are still marked{' '}
          <span className="font-bold">to be completed</span> in{' '}
          <code className="rounded bg-club-ink/8 px-1 py-0.5">
