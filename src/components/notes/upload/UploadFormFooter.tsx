...
export function UploadFormFooter({
  ...
  return (
    <div className="flex flex-col gap-4 border-t-[1.5px] border-club-ink bg-club-lavender p-5 sm:flex-row sm:items-center sm:justify-between sm:p-6">
      <div aria-live="polite" className="min-h-6 text-sm font-bold">
        {error ? (
          ...
          <span className="flex items-center gap-2 text-club-purple">
